...
export default function App() {
  ...
  useEffect(() => {
    ...
    const manualKeys = suppliers.filter(
      (k) => manualInputs[k] && manualInputs[k] !== ""
    );
    const manualSum = manualKeys.reduce(
      (sum, k) => sum + parseNumber(manualInputs[k]),
      0
    );
    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={(e) =>
            setManualTotal(e.target.value.replace(/[^0-9,]/g, ""))
          }
      ...
      <div className="mb-4 border-t pt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setVatInput(e.target.value.replace(/[^0-9,]/g, ""))
          }
